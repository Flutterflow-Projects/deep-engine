...
import 'create_an_account_passkey_model.dart';
export 'create_an_account_passkey_model.dart';

class CreateAnAccountPasskeyWidget extends StatefulWidget {
  const CreateAnAccountPasskeyWidget({super.key});

  @override
  State<CreateAnAccountPasskeyWidget> createState() =>
      _CreateAnAccountPasskeyWidgetState();
}

class _CreateAnAccountPasskeyWidgetState
    extends State<CreateAnAccountPasskeyWidget> {
  late CreateAnAccountPasskeyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateAnAccountPasskeyModel());
