...
import 'create_an_account_sign_up_model.dart';
export 'create_an_account_sign_up_model.dart';

class CreateAnAccountSignUpWidget extends StatefulWidget {
  const CreateAnAccountSignUpWidget({super.key});

  @override
  State<CreateAnAccountSignUpWidget> createState() =>
      _CreateAnAccountSignUpWidgetState();
}

class _CreateAnAccountSignUpWidgetState
    extends State<CreateAnAccountSignUpWidget> {
  late CreateAnAccountSignUpModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateAnAccountSignUpModel());
