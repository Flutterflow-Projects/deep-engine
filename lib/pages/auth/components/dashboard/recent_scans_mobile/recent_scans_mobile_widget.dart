...
import 'recent_scans_mobile_model.dart';
export 'recent_scans_mobile_model.dart';

class RecentScansMobileWidget extends StatefulWidget {
  const RecentScansMobileWidget({super.key});

  @override
  State<RecentScansMobileWidget> createState() =>
      _RecentScansMobileWidgetState();
}

class _RecentScansMobileWidgetState extends State<RecentScansMobileWidget> {
  late RecentScansMobileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RecentScansMobileModel());
